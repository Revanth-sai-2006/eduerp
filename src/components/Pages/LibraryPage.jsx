    ...
    <div id="library-page" className="page-content active">
      ...
      <div className="card">
        <div className="card-header">
          ...
          <button className="card-action" id="add-borrowing-btn">Add Borrowing Record</button>
        </div>
          ...
          <tbody id="borrowing-table-body">
            {borrowings.map(borrowing => (
              <tr key={borrowing.id}>
                ...
                <td>
                  <button className="btn btn-outline view-borrowing-btn" data-id={borrowing.id}>View</button>
                  <button 
