    ...
    <div id="finance-page" className="page-content active">
      ...
      <div className="card">
        <div className="card-header">
          ...
          <button className="card-action" id="add-transaction-btn">Add Transaction</button>
        </div>
          ...
          <tbody id="transaction-table-body">
            {transactions.map(transaction => (
              <tr key={transaction.id}>
                ...
                <td>
                  <button className="btn btn-outline view-transaction-btn" data-id={transaction.id}>View</button>
                  <button 
