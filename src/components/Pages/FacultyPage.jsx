    ...
    <div id="faculty-page" className="page-content active">
      ...
      <div className="card">
        <div className="card-header">
          ...
          <button className="card-action" id="add-faculty-btn">Add New Faculty</button>
        </div>
          ...
          <tbody id="faculty-table-body">
            {faculty.map(facultyMember => (
              <tr key={facultyMember.id}>
                ...
                <td>
                  <button className="btn btn-outline view-faculty-btn" data-id={facultyMember.id}>View</button>
                  <button className="btn btn-warning edit-faculty-btn" data-id={facultyMember.id}>Edit</button>
                  <button 
