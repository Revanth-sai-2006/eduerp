    ...
    <div id="students-page" className="page-content active">
      ...
      <div className="card">
        <div className="card-header">
          ...
          <button className="card-action" id="add-student-btn-2">Add New Student</button>
        </div>
          ...
          <tbody id="student-table-body">
            {students.map(student => (
              <tr key={student.id}>
                ...
                <td>
                  <button className="btn btn-outline view-student-btn" data-id={student.id}>View</button>
                  <button className="btn btn-warning edit-student-btn" data-id={student.id}>Edit</button>
                  <button 
